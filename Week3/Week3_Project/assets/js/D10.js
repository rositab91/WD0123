...
const string = 'I need to study more';
const arrayString = splitMe(string);
...
console.log(deleteOne('welcome', true));
console.log(deleteOne('everybody', false));
...
function whatDayIsIt() {
  ...
  if (daysOfWeek[dayOfWeek] === 'Friday') {
    return 'Friday';
  }
  return null;
}
...
function isTodayMyBirthday() {
  const today = new Date();
  const birthdate = new Date(1991, 2, 26); // Mese inizia da 0, quindi marzo è il mese 2
...
function deleteProp(object, propName) {
...
const newPerson = deleteProp(person, 'city');
...
*/
const tdTab = document.querySelectorAll('td');
console.log(tdTab);
